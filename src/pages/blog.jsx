    ...
    <Fragment>
      <div>
        ...
        <div
          ...
          style={{ backgroundImage: "url(./assets/img/bg-img/breadcumb2.jpg)" }}
        >
            ...
            <div className="row">
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog1.jpg" alt />
                  {/* Post Title */}
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog2.jpg" alt />
                  {/* Post Title */}
                  <div className="post-title">
                    <a href="#">
                      Vivamus sed nunc in arcu cursus mollis quis et orci.
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog3.jpg" alt />
                  {/* Post Title */}
                  <div className="post-title">
                    <a href="#">
                      Vivamus sed nunc in arcu cursus mollis quis et orci.
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog4.jpg" alt />
                  {/* Post Title */}
                  <div className="post-title">
                    <a href="#">
                      Vivamus sed nunc in arcu cursus mollis quis et orci.
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog5.jpg" alt />
                  {/* Post Title */}
                  <div className="post-title">
                    <a href="#">
                      Vivamus sed nunc in arcu cursus mollis quis et orci.
              ...
              <div className="col-12 col-lg-6">
                <div className="single-blog-area mb-50">
                  <img src="./assets/img/bg-img/blog6.jpg" alt />
                  {/* Post Title */}
                  <div className="post-title">
                    <a href="#">
                      Vivamus sed nunc in arcu cursus mollis quis et orci.
